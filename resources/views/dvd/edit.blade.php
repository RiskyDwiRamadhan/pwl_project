                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="card mb-9">
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" action="{{ route('dvd.update', $dvd->id_dvd) }}" id="myForm" enctype="multipart/form-data" data-parsley-validate novalidate>                                    
                                    @csrf
                                    @method('PUT')
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $dvd->id_dvd }}" name="id_dvd" data-parsley-trigger="change" class="form-control" id="id_dvd" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="nama_dvd">Nama DVD<span class="text-danger">*</span></label>
                                        <input type="text" value="{{ $dvd->nama_dvd }}" name="nama_dvd" data-parsley-trigger="change" required placeholder="Masukkan Nama DVD" class="form-control" id="nama_dvd">
                                    </div>
                                    <div class="form-group">
                                        <label for="harga_dvd">Harga DVD<span class="text-danger">*</span></label>
                                        <input type="text" value="{{ $dvd->harga_dvd }}" name="harga_dvd" data-parsley-trigger="change" required placeholder="Masukkan Harga DVD" class="form-control" id="harga_dvd">
                                    </div>
                                    <div class="form-group">
